...
/**
 * Provides a list controller for the elections contest entity type.
 */
class ElectionsContestListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new ElectionsContestListBuilder object.
   *
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total elections contests: @total', ['@total' => $total]);
    return $build;
  }
